...
def get_arg_parser() -> argparse.ArgumentParser:
    ...
    common_group.add_argument('-a', '--actions', nargs='*',
        ...
        help="the list of actions to execute for each dataset, chosen among "
            "(case insensitive): ANALYSE, SCCS_BIN, SCCS_MIP, SCCS_QO, "
            "SCCS_GRASP (default)")
    ...
    grasp_group.add_argument('--grasp-presolve', type=float, default=None,
            metavar="PRESOLVE", help="subsets available for the construction of "
            "a feasible solution during the first phase of the GRASP algorithm "
    ...
    gurobi_group = arg_parser.add_argument_group(title="Gurobi arguments",
        description="Arguments that affect only SCCS_BIN, SCCS_MIP and SCCS_QO actions")
