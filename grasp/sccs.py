...
def run_sccs(
    ...
    result = GraspResult(
        ...
        # Runtime info
        # '(user|system|presolve|init|total)_time' and 'time_to_best'
    ...
    if worker_count == 1:
        ...
        with Manager() as manager:
            ...
            workers = [
                Process(target=run_two_stage_sccs, args=(
                    data.id, data.conflict_threshold, max_candidates,
    ...
    end_at = time()
    result.solve_time = end_at - solve_time_start
